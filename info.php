    ...
    <body>
        <div id="wrapper">
            ...
            <div id="texto">
                ...
                <img class="img" id="pangolininfo1" src="img/info_1.jpg" alt="Pangolín en cautividad"/>
                <div>
                ...
                <img class="img" id="pangolininfo2" src="img/info_2.png" alt="Huesos de Pangolín. Animal cazado para alimentarse"/>
                <div>
                ...
                <img class="img" id="pangolininfo3" src="img/info_3.jpg" alt="Escamas de Pangolín"/>
                <div>
